...
async def sleep_cmd(interaction: discord.Interaction):
    ...
    # Optional: restrict usage to allowed channels only (uncomment to enforce)
    # if interaction.channel_id not in allowed_channels:
    #     await interaction.response.send_message("❌ You can't use /sleep in this channel.", ephemeral=True)
    #     return
